                    ...
                    if (response.success == true) {
                       ...
                       if (response.data.super_admin ==1) {
                        var row = $('<tr>')
                                    ...
                                    .append(`<td><button type='button' class='btn btn-outline-dark' onclick='viewUser(${response.data.id})'>
                                <i class='fa fa-eye'></i>
                            </button>
                            <button type='button' class='btn btn-outline-primary' onclick='editUser(${response.data.id})'>
                        ...
                        //     `
                            // <button type='button' class='btn btn-outline-dark' onclick='viewUser(${response.data.id})'>
                            //     <i class='fa fa-eye'></i>
                            // </button>
                            // <button type='button' class='btn btn-outline-primary' onclick='editUser(${response.data.id})'>
                            //     <i class='mdi mdi-pencil'></i>
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            if (response.data.super_admin==1) {
                                ...
                                <td><button type='button' class='btn btn-outline-dark' onclick='viewUser(${response.data.id})'>
                                <i class='fa fa-eye'></i>
                            </button>
                            <button type='button' class='btn btn-outline-primary' onclick='editUser(${response.data.id})'>
                                <i class='mdi mdi-pencil'></i>
